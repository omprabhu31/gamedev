...
%This is the end of the notes from Week 3 of the course. In the next project, will be creating an actual game called `Box Shooter' which will put into action all the previously discussed concepts and more. Continue reading forward, or head over into Unity and try out some stuff yourself.
...
\hrulefill
%\begin{center}\textbf{END OF COURSE NOTES}\end{center}
%This is the end of the course notes. Thank you for showing interest and reading till the end. If you have any suggestions for this or other documents, feel free to contact me using the links on my website.
